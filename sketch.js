...
var emptStar, lonelyStar, twoStar
var starDisplay
...
function preload()
{
  ...
  emptStar = loadAnimation ('empty.png');
  lonelyStar = loadAnimation ('one_star.png');
...
function setup() 
{
  ...
  starDisplay. addAnimation ('empty',emptStar,);
  starDisplay. addAnimation ('lonely', lonelyStar);
...
function draw() 
{
  ...
  if (collide (fruit,star,20)==true){
    star.visible = false; 
    starDisplay.changeAnimation ('lonely');
